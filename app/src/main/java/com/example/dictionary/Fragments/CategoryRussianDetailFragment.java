...
public class CategoryRussianDetailFragment extends Fragment implements View.OnClickListener {

     List<Words> wordsList = new ArrayList<>();
     CategoryDetailAdaptor detailsAdapter;
    ...
    public CategoryRussianDetailFragment() {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        detailsAdapter = new CategoryDetailAdaptor(getActivity(), wordsList, mBottomSheetBehavior, new CategoryDetailAdaptor.OnItemClickListener() {
            @Override
